package com.sweagle.message.constants;
...
public class MessageConstants {
	...
	public static final String FAULT_INVALID_REQUEST="Invalid request! Please be sure that you enter all the required inputs.";
	public static final String FAULT_INVALID_PERIOD="Please be sure you enter only day or week for the period parameter!";
}
